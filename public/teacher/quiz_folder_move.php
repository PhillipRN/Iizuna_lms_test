...
if (isset($_POST['quiz_id']))
{
    ...
    $result = (new JsonQuizMover())->MoveQuiz($teacher->id, $quizId, $parentFolderId);
...
{
    DisplayJsonHelper::ShowErrorAndExit(Error::ERROR_JSON_QUIZ_FOLDER_MOVE_QUIZ_INVALID_PARAMETER);
}